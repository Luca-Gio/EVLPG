...
"""
"""
MASTER PROJECT: Open-Source module for the investigation on the impaczt of EVs in a Low Voltage grid
"""
#***********************************************************
# IMPORT LIBRARIES
#***********************************************************
import os,fnmatch
os.chdir(os.path.dirname(os.path.realpath('Master.py')))
